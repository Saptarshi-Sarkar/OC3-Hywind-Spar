...
%  -----------------------------------------                   
disp('Reading the wind field summary file....');
...
if ( fid_sum <= 0 )
    ...
    error(['Could not open the wind field summary file: ' FileName '.sum']);
    return;
end
...
%-----------------------------------------                   
disp('Reading and scaling the wind field grid data...');
